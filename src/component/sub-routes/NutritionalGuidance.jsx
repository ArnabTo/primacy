        ...
        <section className="bg-white mb-44">
            <div className=' mt-20 space-y-3'>
                ...
                <p className='text-textColor text-lg lg:text-xl text-center font-tinos mx-5 md:mx-12'>
                    Orientação personalizada para melhorar os seus hábitos alimentares e complementar o seu plano de treino. Receba conselhos <br className="hidden xl:block"></br>  sobre nutrição  balanceada e
